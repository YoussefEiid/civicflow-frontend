...
const envSchema = z.object({
  ...
  WHATSAPP_PROVIDER: z.string().default('ultramsg'),
  WHATSAPP_API_URL: z.string().default('https://api.ultramsg.com/instance191672/messages/chat'),
  WHATSAPP_API_KEY: z.string().default('xp6rt5dva1hbclsv'),
